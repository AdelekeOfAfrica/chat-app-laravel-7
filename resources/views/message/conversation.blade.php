...
<div class="row">
    ...
    <div class ="col-md-9 chat-section">
        <div class ="chat-header">
            <div class ="chat-image">
               <i class="fas fa-comment" style="position:relative; color:#f8fafc;"></i>
            </div>
            <div class="Chat-name font-weight-bold">
                Start A Conversation 
                <i class="fa fa-circle user-status-head" id="userStatusHead{{$friendInfo->id}}" title="away" style="color:#f8fafc;"></i>
            </div>
        </div>
